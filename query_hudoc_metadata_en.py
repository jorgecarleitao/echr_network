...
def echr_crawler(urlstring, mode='ALL'):
    ...
    log = Log()
    log.log_config('echr', 'echr_resolutions.log')
    ...
    try:
        ...
        while documentCount <= totaldocs:
            ...
            for results in data["results"]:
                ...
                if results["columns"]["HASHTML"] == "1" or results["columns"]["HASPDF"] == "1" or results["columns"]["HASDOCX"] == "1" :
                    continue
...
if __name__ == '__main__':
    ...
    urlstring += 'q=NOT%20(DOCTYPE%3DPR%20OR%20DOCTYPE%3DHFCOMOLD%20OR%20DOCTYPE%3DHECOMOLD)%20AND%20(languageisocode%3D%22ENG%22)%20AND%20(documentcollectionid%3D%22JUDGMENTS%22%20OR%20documentcollectionid%3D%22DECISIONS%22%20OR%20documentcollectionid%3D%22RESOLUTIONS%22)%20AND%20(kpdate%3E%3D%222014-01-01T00%3A00%3A00.0Z%22%20AND%20kpdate%3C%3D%222014-03-31T00%3A00%3A00.0Z%22)'
    urlstring +='&s=&st={:d}&c=500&f=0&TID=iinrswnkdb'
    #===========================================================================
